// window.site_url = 'http://localhost/sourcecodester/attmonsys/';
jQuery(document).ready(function($) {
    ...
    var desktopView = Backbone.View.extend({
        ...
        deleteStudent: function(evt) {
            ...
            evt.preventDefault();
            $.post("ajax.php", { sid: $(_this).attr('sid'), action: 'deleteStudent' },
        ...
        deleteSubject: function(evt) {
            var _this = $(evt.target);
            evt.preventDefault();
            $.post("ajax.php", { subjid: $(_this).attr('subjid'), action: 'deleteSubject' },
                function(responseText, responseStatus) {
        ...
        teacherLogAttendance: function(evt) {
            var _this = $(evt.target);
            evt.preventDefault();
            $.post("ajax.php", { subjtid: $(_this).attr('subjtid'), action: 'teacherLogAttendance' },
                function(responseText, responseStatus) {
                    $.ajax({
                        url: 'ajax.php',
                        type: 'POST',
        ...
        deletePersonnel: function(evt) {
            var _this = $(evt.target);
            evt.preventDefault();
            $.post("ajax.php", { personnel_id: $(_this).attr('personnelid'), action: 'deletePersonnel' },
                function(responseText, responseStatus) {
        ...
        deleteYearLevel: function(evt) {
            var _this = $(evt.target);
            evt.preventDefault();
            $.post("ajax.php", { yearlevelid: $(_this).attr('yearlevelid'), action: 'delete_yearlevel' },
                function(responseText, responseStatus) {
        ...
        loadIndex: function() {
            $.post("home.php", { valid: "yes" },
                function(responseText, responseStatus) {
                    $("#contextArea").html(responseText);
                });
        },
        loadTeacher: function() {
            $.post("teacher.php", { valid: "yes" },
                function(responseText, responseStatus) {
                    $("#contextArea").html(responseText);
                });
        },
        loadStudent: function() {
            $.post("student.php", { valid: "yes" },
                function(responseText, responseStatus) {
                    $("#contextArea").html(responseText);
                });
        },
        loadSubject: function() {
            $.post("subject.php", { valid: "yes" },
                function(responseText, responseStatus) {
                    $("#contextArea").html(responseText);
                });
        },
        loadAttendance: function() {
            $.post("attendance.php", { valid: "yes" },
                function(responseText, responseStatus) {
                    $("#contextArea").html(responseText);
                    viewDesktop.loadDatePicker();
                });
        ...
        loadAttendanceLog: function() {
            $.post("attendance-log.php", { valid: "yes" },
                function(responseText, responseStatus) {
                    $("#contextArea").html(responseText);
                    viewDesktop.loadDatePicker();
                });
        ...
        loadStudentInfo: function(sid) {
            $.post("studentinfo.php", { valid: "yes", sid: sid },
                function(responseText, responseStatus) {
                    $("#contextArea").html(responseText);
        ...
        loadTeacherInfo: function(tid) {
            $.post("teacherinfo.php", { valid: "yes", tid: tid },
                function(responseText, responseStatus) {
                    $("#contextArea").html(responseText);
        ...
        loadYearLevelInfo: function(yearlevelid) {
            $.post("yearlevelinfo.php", { valid: "yes", yearlevelid: yearlevelid },
                function(responseText, responseStatus) {
                    $("#contextArea").html(responseText);
                });
        },
        loadYearLevelSectionInfo: function(yearlevelid, yearlevelsectionid) {
            $.post("yearlevelsectioninfo.php", { valid: "yes", yearlevelsectionid: yearlevelsectionid, yearlevelid: yearlevelid },
                function(responseText, responseStatus) {
                    $("#contextArea").html(responseText);
                });
        },
        loadYearLevelSectionStudents: function(yearlevelid, yearlevelsectionid) {
            $.post("yearlevelsectionstudents.php", { valid: "yes", yearlevelsectionid: yearlevelsectionid, yearlevelid: yearlevelid },
                function(responseText, responseStatus) {
                    $("#contextArea").html(responseText);
                });
        },
        teachersList: function() {
            $.post("teacherslist.php", { valid: "yes" },
                function(responseText, responseStatus) {
                    $("#contextArea").html(responseText);
                });
        },
        sectionInfo: function() {
            $.post("sectioninfo.php", { valid: "yes" },
                function(responseText, responseStatus) {
                    $("#contextArea").html(responseText);
                });
        },
        teachersStudents: function() {
            $.post("teacherstudents.php", { valid: "yes" },
                function(responseText, responseStatus) {
                    $("#contextArea").html(responseText);
                });
        },
        personnel: function() {
            $.post("personnel.php", { valid: "yes" },
                function(responseText, responseStatus) {
                    $("#contextArea").html(responseText);
                });
        },
        yearlevel: function() {
            $.post("yearsection.php", { valid: "yes" },
                function(responseText, responseStatus) {
                    $("#contextArea").html(responseText);
                });
        },
